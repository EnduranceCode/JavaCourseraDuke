...
public class Part3 {
	...
	/**
	 * Counts the number of genes in a given dna strand
	 * 
	 * @param	dna
	...
	public int countGenes(String dna) {
		...
		/* Track the number of genes in the given dna strand and set it to zero */
		int numberGenes = 0;
		...
		while (true) {
			...
			if (startIndex == -1) {
				...
				if (!(stopCodonTAA == dna.length() && stopCodonTAG == dna.length() && stopCodonTGA == dna.length())) {
					...
					/* We then increase the number of genes found */
					numberGenes += 1;
	...
	public void testCountGenes() {
		...
		System.out.println("The number of found genes is " + countGenes(dna));
		System.out.println();
